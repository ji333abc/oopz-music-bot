...
LEGACY_DATA_DIR = Path(os.getenv("OOPZ_LEGACY_DATA_DIR") or os.path.join(PROJECT_ROOT, "data"))
CONFIG_PATH = str(LEGACY_DATA_DIR / "oopz_credentials.json")
CONFIG_EXAMPLE_PATH = ""
PRIVATE_KEY_PATH = str(LEGACY_DATA_DIR / "private_key.pem")
BROWSER_DATA_DIR = str(LEGACY_DATA_DIR / "oopz_admin_login_profile")
CHROMIUM_RUNTIME_DIR = str(LEGACY_DATA_DIR / "chromium_runtime")
...
def _get_chromium_executable_path() -> Optional[str]:
    ...
    path = (
        ...
        or os.environ.get("OOPZ_VOICE_BROWSER_EXECUTABLE_PATH")
