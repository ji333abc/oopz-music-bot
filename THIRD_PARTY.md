...
- [sansenjian/qq-music-api](https://github.com/sansenjian/qq-music-api)（MIT）：Docker Compose 使用的 QQ 音乐接口，固定 npm 版本 `@sansenjian/qq-music-api@2.4.0`，与旧版原生部署保持一致。源码和依赖保持在独立容器中。
